...
function getById(req, res, next) {
    user_service_1.userService.getById(parseInt(req.params.id))
...
function update(req, res, next) {
    user_service_1.userService.update(parseInt(req.params.id), req.body)
        .then(() => res.json({ message: 'User updated successfully' }))
        .catch(next);
}
function _delete(req, res, next) {
    user_service_1.userService.delete(parseInt(req.params.id))
